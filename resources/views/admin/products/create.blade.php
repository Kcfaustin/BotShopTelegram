...
<div class="max-w-2xl mx-auto">
    <form action="{{ route('admin.products.store') }}" method="POST" enctype="multipart/form-data" class="bg-white shadow-sm ring-1 ring-gray-900/5 sm:rounded-xl md:col-span-2">
        @csrf
        <div class="px-4 py-6 sm:p-8">
            <div class="grid max-w-2xl grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                ...
                <div class="sm:col-span-2">
                    ...
                    <div class="mt-2">
                        <input type="number" name="price" id="price" value="{{ old('price') }}" required min="0" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                    </div>
                ...
                <div class="col-span-full">
                    ...
                    <div class="mt-2">
                        <input type="text" name="telegram_file_id" id="telegram_file_id" value="{{ old('telegram_file_id') }}" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                    </div>
                    <p class="mt-2 text-sm text-gray-500">Utilisez ceci SI le fichier est trop lourd (> 50Mo). Envoyez le fichier au bot admin pour obtenir son ID.</p>
                </div>

                <div class="col-span-full">
                    <label for="file" class="block text-sm font-medium leading-6 text-gray-900">OU Téléverser un fichier (max 50Mo)</label>
                    <div class="mt-2 flex justify-center rounded-lg border border-dashed border-gray-900/25 px-6 py-10">
                        <div class="text-center">
                            ...
                            <p class="text-xs leading-5 text-gray-600">PDF, ZIP, PNG, JPG jusqu'à 50MB</p>
                            <div id="file-name" class="mt-2 text-sm text-gray-900 font-medium"></div>
                        </div>
                    </div>
